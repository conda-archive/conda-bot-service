...
def get_version(module='conda_bot_service'):
    """Get version."""
...
setup(
    ...
    version=get_version(),
    keywords=[],
    url='https://github.com/conda/conda-bot-service',
    license='MIT',
    ...
    description='conda-bot-service application.',
